...
const Page = () => {
  return (
    <div className={styles.page}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to TaskMaster.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to TaskMaster, accessible from{" "}
            <a
              href="https://taskmasterapp.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://taskmasterapp.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: support@taskmasterapp.com</li>
      </ul>
    </div>
  );
};
