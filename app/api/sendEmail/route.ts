                    ...
                    <tr>
                      <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                        <table border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td onclick="copy()" align="center" bgcolor="#1a82e2" style="border-radius: 6px; padding: 0px 10px !important;letter-spacing: 0.5px;font-size:20px">
                              <p>${decryptString(body.code, true)}</p>
                            </td>
                          </tr>
                        </table>
                            <br/>
